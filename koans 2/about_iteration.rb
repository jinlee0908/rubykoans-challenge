...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # the result of each run of the block is stored in the accumulator and then 
    # passed to the next execution of the block. In the case of the code shown above,
    # you are defaulting the accumulator, result, to 0. Each run of the block adds the
    # given number to the current total and then stores the result back into the 
    # accumulator. The next block call has this new value, adds to it, stores it
    # again, and repeats.  
